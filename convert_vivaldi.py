#!/usr/bin/env python3
"""
Convert Vivaldi musedata archive (stage2 files) to MusicXML.

Source: C:/m_a/kern/musedata/vivaldi/
Output: C:/m_a/lilypond/musicxml/

Usage:
    python convert_vivaldi.py [--filter op8] [--dry-run]
"""
...
def _fix_xml_int_nodes(el):
    ...
    for child in el: _fix_xml_int_nodes(child)
