#!/usr/bin/env python3
"""Convert Beethoven musedata archive to MusicXML. Source: kern/musedata/beethoven/"""

import argparse, tempfile
from pathlib import Path
import music21

BEETHOVEN_ROOT = Path('C:/m_a/kern/musedata/beethoven')
